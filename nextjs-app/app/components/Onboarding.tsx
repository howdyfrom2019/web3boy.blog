  ...
  return (
    <>
      ...
      <div>
        {!isPresentation ? (
          <Link
            className="inline-flex rounded-full gap-2 items-center bg-white text-blue-500 hover:bg-blue-100 focus:bg-blue-200 py-3 px-6 transition-colors duration-200"
            href={link.href}
            target="_blank"
          >
            {link.title}
          ...
          <button
            className="cursor-pointer inline-flex rounded-full gap-2 items-center bg-white text-blue-500 hover:bg-blue-100 focus:bg-blue-200 py-3 px-6 transition-colors duration-200"
...
export default function Onboarding() {
  return (
    <div className="max-w-2xl mx-auto grid grid-flow-row gap-6 py-12 text-center bg-blue-500 text-white rounded-lg p-8">
      <svg
